...
static int iris_emv_expected_timeout;
...
bool iris_emv_is_known_timeout_i7(void)
{
	if ((iris_emv_expected_timeout > 0) && iris_emv_game_mode_enabled_i7()) {
		iris_emv_expected_timeout = 0;
		return true;
	}
	iris_emv_expected_timeout = 0;
        return false;
