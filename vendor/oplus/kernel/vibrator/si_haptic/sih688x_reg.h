...
#define SIH_ANA_CTRL5_BST_OCP_VRSEL_6_8			(0x3 << 1)
#define SIH_ANA_CTRL5_BST_OCP_VRSEL_8_10		(0x2 << 1)
#define SIH_ANA_CTRL5_BST_OCP_VRSEL_10_11		(0x1 << 1)
...
/* BRK_CTRL1 */
#define SIH_SMOOTH_BYPASS_OUTPUT_MASK           (1 << 4)
#define SIH_SMOOTH_BYPASS_OUTPUT_OFF            (0 << 4)
